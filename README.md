...
[ANSWER]Sessions is server side while web tokens are client side
2. What does `bcrypt` do to help us store passwords in a secure manner.
[ANSWER] Bcrypt hashes our passwords to secure them
3. How are unit tests different from integration and end-to-end testing.
[ANSWER] Unit tests test one specific block in your code, while integration tests test multiple blocks of code as a group, and end to end tests test the flow of your whole code from start to finish.
4. How _Test Driven Development_ changes the way we write applications and tests.
[ANSWER] It makes us cover all bugs that may appear without testing, which usually makes for more efficient code and less security risks.
